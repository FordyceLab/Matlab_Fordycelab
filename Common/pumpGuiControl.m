function pump = pumpGuiControl(getVc, setValve, uiH, uiPrefix, initialDir, errorLog)
% GUI pump control system closure
%
% pump = pumpGuiControl(getVc, setValve, uiH, uiPrefix, errorLog)
%
...
%            logging is needed.
%
% R. Gomez-Sjoberg, 12/01/11

myName = 'Pump Controller';
myTag = 'pumpGuiControl';
