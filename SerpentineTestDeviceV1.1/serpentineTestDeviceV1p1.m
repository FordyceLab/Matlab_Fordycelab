function chip = serpentineTestDeviceV1p0A(vcType, valveNumFile, virtual, slave, masterName)
% Serpentine Test Device v1.1 Chip Control System
%
% chip = serpentineTestDevicev1.1(vcType, valveNumFile, virtual, slave, masterName)
%
...
%
% R. Gomez-Sjoberg, Camilo Diaz-Botia, Polly Fordyce 03/06/2013

fileSeparator = filesep();

myName = 'Serpentine Test Device v1.1';
myTag = 'serpentineTestDeviceV1p1';
...
% Returns the folder where this m file is
    ...
    function drawChip
        ...
        try
            ...
            img = imread('SerpentineChannelTestDevice_v1.1', 'png');
            for jj = 1:3
...
% --- Executes on menu select in About.
    function About_Callback(hObject, ~)
        ...
        str = {'Serpentine Test Device v1.1'; 'July 2013'; ' '; ...
            'Polly Fordyce, Rafael Gómez-Sjöberg, Camilo Díaz-Botía'; 'UCSF/LBNL'};
        img = imread('about_pic3.bmp');
        aboutdlg('Title', 'Serpentine Test Device', 'String', str, 'Image', img);
