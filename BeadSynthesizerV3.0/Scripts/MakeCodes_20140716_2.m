...
% P. Fordyce and B. Baxter 07/16/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140716-02.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140716-02.txt');
...
% Mixer 1
mixData.M1.C1 = 1.0622; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0447; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.2295; %RTm/REu = WidthEu/WidthTm
