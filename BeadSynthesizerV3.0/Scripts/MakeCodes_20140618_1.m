% Script to generate 4 Eu/Er codes [0, 0.25, 0.5, 1.0]
% Er is in Sm input channel (C2), so keep most of this code and leave
% things as running 4 levels of "Sm"

% P. Fordyce and B. Baxter 06/16/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140618-01.txt');
