...
% P. Fordyce and B. Baxter 06/25/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140625-02.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140625-02.txt');

% Chip serial code
chipSerial = 'BS3.0A-PMF-06.12.14-ch01';
...
% Mixer 1
mixData.M1.C1 = 1.0198; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0262; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.1047; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/52.57; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
...
mixData.M2.Cmix = 1/52.57; %Rmix/REu = Pmix/(PEu - Pmix)
