...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20130515-05.txt');

% Chip serial code
chipSerial = 'BS3.0-CAD-04.19.13-ch03';
...
Sm = [0, 0.12, 0.27, 0.46, 0.7, 1];
Dy = [0, 0.12, 0.27, 0.46, 0.7, 1];
Tm = [0, 0.12, 0.27, 0.46, 0.7, 1];
...
% [Sm, Dy, Tm, Eu]
lanthanideMfcsCh = [6, 7, 8, 5];

% Chip input valve names used for the lanthanides
% [Sm, Dy, Tm, Eu]
lanthanideValves = {'C8'; 'C7'; 'C6'; 'C1'};
...
% Mixer 1
mixData.M1.C1 = 1.247; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.311; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.298; %RTm/REu = WidthEu/WidthTm
