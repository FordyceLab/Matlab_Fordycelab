...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20130514-01.txt');

% Chip serial code
chipSerial = 'BS3.0-CAD-04.19.13-ch02';
...
% Mixer 1
mixData.M1.C1 = 0.9424; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 0.5859; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 0.9424; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/36.5; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
mixData.M2.C1 = 0.9424; %RSm/REu = WidthEu/WidthSm
mixData.M2.C2 = 0.5859; %RDy/REu = WidthEu/WidthDy
mixData.M2.C3 = 0.9424; %RTm/REu = WidthEu/WidthTm
...
%                 chip.closeValve('MxWaste');
                ...
                chip.closeValves(lanthanideValves); pause(0.3)
%                 chip.closeValve('MxWaste'); pause(0.3)
