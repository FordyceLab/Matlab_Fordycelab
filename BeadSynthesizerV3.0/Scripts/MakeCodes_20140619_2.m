...
% All contain 1:8diulution from stock of Eu

% P. Fordyce and B. Baxter 06/19/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140619-02.txt');
...
% Mixer 1
mixData.M1.C1 = 1.068; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.054; %RDy/REu = WidthEu/WidthDy
