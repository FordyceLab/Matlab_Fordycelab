...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140421-01.txt');

% Chip serial code
chipSerial = 'BS3.0A-PMF-04.08.14-ch02';
...
% Mixer 1
mixData.M1.C1 = 1.00; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.23; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/99; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
mixData.M2.C1 = 1.00; %RSm/REu = WidthEu/WidthSm
mixData.M2.C2 = 1.23; %RDy/REu = WidthEu/WidthDy
