%Remake Code 20, missed in original sequence...

%Script to generate 26 code set with Eu, Sm, Dy, and Tm using 1:4 Tm this
%time.
...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140702-01_code20.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140702-01_code20.txt');
...
% Mixer 1
mixData.M1.C1 = 1.0159; %RSm/REu = WidthEu/WidthSm
