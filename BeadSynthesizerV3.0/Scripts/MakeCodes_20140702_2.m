% Script to generate 82 code set at 5 SD with some levels of Tm
...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140702-02.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140702-02.txt');
...
% Mixer 1
mixData.M1.C1 = 1.03; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0524; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.1775; %RTm/REu = WidthEu/WidthTm
