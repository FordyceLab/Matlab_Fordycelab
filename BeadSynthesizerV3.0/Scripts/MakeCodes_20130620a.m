% Script to generate Tm/Eu + Dy/Eu codes
% Based on Rachel's code from 2/10/12
%
% R. Gomez-Sjoberg 5/17/12
% C. Diaz-Botia 11/15/12

% % Specific changes for this run. DO NOT use as a template

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20130620-01.txt');

% Chip serial code
chipSerial = 'BS3.0-CAD-05.22.13-ch04';
...
Sm = [0, 0.12, 0.27, 0.46, 0.7, 1, 0, 0.12, 0.27, 0.46, 0.7, 1];
Dy = [0, 0.12, 0.27, 0.46, 0.7, 1, 0, 0.12, 0.27, 0.46, 0.7, 1];
Tm = [0];
...
% [Sm, Dy, Tm, Eu]
lanthanideMfcsCh = [6, 5, 7, 4];

% Chip input valve names used for the lanthanides
% [Sm, Dy, Tm, Eu]
lanthanideValves = {'C6'; 'C3'; 'C8'; 'C1'};
...
% Mixer 1
mixData.M1.C1 = 0.95; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 0.992; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 0.90; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/36.5; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
mixData.M2.C1 = 1.247; %RSm/REu = WidthEu/WidthSm
mixData.M2.C2 = 1.311; %RDy/REu = WidthEu/WidthDy
mixData.M2.C3 = 1.298; %RTm/REu = WidthEu/WidthTm
mixData.M2.Cmix = 1/36.5; %Rmix/REu = Pmix/(PEu - Pmix)
