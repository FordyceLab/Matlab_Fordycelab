% Script to generate 83 code set at 5 SD (no Tm yet)
% 10 levels of Sm and Dy
% P. Fordyce and B. Baxter 06/23/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140623-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.080; %RSm/REu = WidthEu/WidthSm
