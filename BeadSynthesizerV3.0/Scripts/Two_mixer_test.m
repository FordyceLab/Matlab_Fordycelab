% Testing this code from Camilo's two mixer run.  Running with water
% inputs and general Pressure values for test 
%

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140627-02.txt');
...
% Mixer 1
mixData.M1.C1 = 1; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/40; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
mixData.M2.C1 = 1; %RSm/REu = WidthEu/WidthSm
mixData.M2.C2 = 1; %RDy/REu = WidthEu/WidthDy
mixData.M2.C3 = 1; %RTm/REu = WidthEu/WidthTm
mixData.M2.Cmix = 1/40; %Rmix/REu = Pmix/(PEu - Pmix)
