...
% P. Fordyce and B. Baxter 06/04/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140604.txt');
...
% BB had to wipe out Tm due to Tm problems.  Run all 4 emitters tomorrow.
...
% Mixer 1
mixData.M1.C1 = 1.114; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.158; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.0000; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/54.5; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
