% Script to generate 11 Sm and Dy vs Eu codes [0, 0.25, 0.5, 1.0]
% All contain 1:4 diulution from stock of Eu

% P. Fordyce and B. Baxter 06/19/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140619-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.038; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 0.968; %RDy/REu = WidthEu/WidthDy
