% Script to generate 83 code set at 5 SD with some levels of Tm
...
% P. Fordyce and B. Baxter 06/24/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140625-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140625-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.099; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.026; %RDy/REu = WidthEu/WidthDy
