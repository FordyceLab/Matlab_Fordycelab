% This makes final two codes of 20140722-01 when bead jam occurred.
...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140722-01-last2codes.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140722-01-last2codes.txt');
