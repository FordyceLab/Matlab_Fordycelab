% Script to generate 4 Eu/CeTb codes [0, 0.25, 0.5, 1.0] with 1:2 CeTb
% CeTb is in Sm input channel (C2), so keep most of this code and leave
...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140717-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140717-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.0716; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 0.9984; %RDy/REu = WidthEu/WidthDy
