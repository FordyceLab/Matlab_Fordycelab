...
% Had to use 1:4 dil Tm input instead of 1:2 since the 1:2 Tm keeps
% aggregating.  First run today only went 4 codes before it chunked up
% after being okay while sitting for 2 hours...  Weird.

% P. Fordyce and B. Baxter 06/05/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140605_2.txt');

% Chip serial code
chipSerial = 'BS3.0A-PMF-05.19.14-ch03';
...
Tm = [0, 0.0901, 0.1997, 0.3330, 0.4951, 0.6922, 0.9320];
% this should produce 180 different codes
...
% Mixer 1
mixData.M1.C1 = 1.024; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.052; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.107; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/52.57; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
mixData.M2.C1 = 1.06349206; %RSm/REu = WidthEu/WidthSm
mixData.M2.C2 = 1.046875; %RDy/REu = WidthEu/WidthDy
