...
% P. Fordyce and B. Baxter 07/23/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140723-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140723-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.0067; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.02; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.1436; %RTm/REu = WidthEu/WidthTm
