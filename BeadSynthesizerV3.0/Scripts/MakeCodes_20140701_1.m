%Script to generate 26 code set with Eu, Sm, Dy, and Tm
...
% P. Fordyce and B. Baxter 07/01/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140701-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140701-01.txt');
...
% Mixer 1
mixData.M1.C1 = 1.113; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0814; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.063; %RTm/REu = WidthEu/WidthTm
