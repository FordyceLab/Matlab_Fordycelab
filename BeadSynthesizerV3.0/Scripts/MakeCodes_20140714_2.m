...
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140714-03.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140714-03.txt');
...
mixData.M1.C3 = 1.1592; %RTm/REu = WidthEu/WidthTm
