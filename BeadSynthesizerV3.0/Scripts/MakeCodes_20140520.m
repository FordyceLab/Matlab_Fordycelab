...
%
% P. Fordyce and B. Baxter 05/20/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140520-01.txt');

% Chip serial code
chipSerial = 'BS3.0B-PMF-05.19.14-ch01';
...
% Mixer 1
mixData.M1.C1 = 1.00131427; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.13173065; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 0.9424; %RTm/REu = WidthEu/WidthTm
mixData.M1.Cmix = 1/37.0; %Rmix/REu = Pmix/(PEu - Pmix)
% Mixer 2
