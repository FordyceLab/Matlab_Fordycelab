% Generate 45 code set with Eu, Sm, Dy using 1:2 Dy this time. 
% Redo of 20140604_withoutTm

% B. Baxter 08/05/2014
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140805-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140805-01.txt');

% Chip serial code
chipSerial = 'BS3.0-PMF-07.30.14-ch01';
...
% Mixer 1
mixData.M1.C1 = 1.0455; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0337; %RDy/REu = WidthEu/WidthDy
