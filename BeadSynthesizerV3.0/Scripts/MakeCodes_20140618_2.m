% Script to generate 4 Eu/CeTb codes [0, 0.25, 0.5, 1.0]
% CeTb is in Dy input channel (C3), so keep most of this code and leave
% things as running 4 levels of "Dy"

% P. Fordyce and B. Baxter 06/18/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140618-02.txt');
...
% Mixer 1
mixData.M1.C1 = 1.076; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.103; %RDy/REu = WidthEu/WidthDy
