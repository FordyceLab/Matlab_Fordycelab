...
% P. Fordyce and B. Baxter 07/14/14
% Attempting to add additional logging about actual MFCS pressures

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140714-01.txt');
mfcsLogFile = fullfile(uigetdir(), filesep, 'PressureLog_20140714-01.txt');

% Chip serial code
chipSerial = 'BS3.0A-PMF-06.12.14-ch04';
...
% Mixer 1
mixData.M1.C1 = 1.0376; %RSm/REu = WidthEu/WidthSm
mixData.M1.C2 = 1.0536; %RDy/REu = WidthEu/WidthDy
mixData.M1.C3 = 1.334; %RTm/REu = WidthEu/WidthTm
