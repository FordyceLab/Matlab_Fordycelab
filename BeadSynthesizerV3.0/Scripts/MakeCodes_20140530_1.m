% Script to generate Sm/Eu and Dy/Eu codes
%
% P. Fordyce and B. Baxter 05/30/14

% Path and name of file to write log to
logFile = fullfile(uigetdir(), filesep, 'SynthesisLog_20140530-01.txt');
