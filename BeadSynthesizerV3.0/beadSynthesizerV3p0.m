function chip = beadSynthesizerV3p0(vcType, valveNumFile, virtual, slave, masterName)
% Bead Synthesis 3.0 chip control system
%
...
myName = 'Bead Synthesis 3.0 Chip';
myTag = 'beadSynthesizerV3p0';
...
% --- Executes on menu select in About.
    function About_Callback(hObject, ~)
        ...
        str = {'Bead Synthesizer ver. 3.0'; 'April 2013'; ' '; ...
            'Rafael Gómez-Sjöberg, Camilo Díaz-Botía'; 'Engineering Division'; 'Lawrence Berkeley National Laboratory'};
