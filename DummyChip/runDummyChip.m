% Activate dummy chip controller with scripting, microscope and
% camera
clear all;
...
[scr, chip, scope, camera, mfcs] = chipAutomation('DummyChip', 'wago', 'ValveNumbers.txt', false, true, false, 'Cameras_LBL.txt', true);
