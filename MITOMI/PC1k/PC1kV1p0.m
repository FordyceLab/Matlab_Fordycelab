function chip = PC1kV1p0(vcType, valveNumFile, virtual, slave, masterName)
% PC1k v1.0 chip control system
%
% chip = beadSynthesizerV3p0(vcType, valveNumFile, virtual, slave, masterName)
%
...
set(myUiH.OpenMx1, 'Callback', @OpenMx1_Callback);
set(myUiH.OpenMx2, 'Callback', @OpenMx2_Callback);
set(myUiH.OpenMixers, 'Callback', @OpenMixers_Callback);
set(myUiH.CloseMixers, 'Callback', @CloseMixers_Callback);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Close all the valves on the chip
    function OpenMx1_Callback(hObject, ~)
        
        myValves.closeValves({'Mx2In' 'Mx2Out'});
        myValves.openValves({'Mx1In' 'Mx1Out'});
        
    end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Close all the valves on the chip
    function OpenMx2_Callback(hObject, ~)
        
        myValves.closeValves({'Mx1In' 'Mx1Out'});
        myValves.openValves({'Mx2In' 'Mx2Out'});
        
    end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Close all the valves on the chip
    function OpenMixers_Callback(hObject, ~)
        
        myValves.openValves({'Mx1In' 'Mx1Out' 'Mx2In' 'Mx2Out'});
        
    end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Close all the valves on the chip
    function CloseMixers_Callback(hObject, ~)
        
        myValves.closeValves({'Mx1In' 'Mx1Out' 'Mx2In' 'Mx2Out'});
...
% --- Executes on menu select in About.
    function About_Callback(hObject, ~)
        ...
        str = {'MITOMI PC1k ver. 1.0'; 'January 2015'; ' '; ...
            'Polly Fordyce, Rafael Gómez-Sjöberg, Camilo Díaz-Botía'; 'Lawrence Berkeley National Laboratory'};
        img = imread('about_pic3.bmp');
        aboutdlg('Title', 'MITOMI Chip', 'String', str, 'Image', img);
