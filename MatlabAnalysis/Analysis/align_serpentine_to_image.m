...
regions_aligned = imtransform(regions, TFORM, 'nearest', 'XData', [1 size(target,2)], 'YData', [1 size(target,1)]);
regions = imtransform(regions_aligned, TFORM2, 'nearest', 'XData', [1 size(target,2)], 'YData', [1 size(target,1)]);
