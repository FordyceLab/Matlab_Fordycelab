...
M0824_1 = squeeze(MMparse('Z:\Images\082912\Beads20120824-01_1'));
M0824_1 = double(M0824_1) - dark_stack;
temp = M0824_1(:,:,2:7).*corrim; %drop brightfield

%regen spectra with right dark correction on device autofluor
%get device background
for n=1:6
    slice = temp(190:450,350:460,n);
...
[M0824_1u,err] = unmix(temp, spectra_df);
err = median(abs(err(:)./temp(:)))
mask = gen_bead_mask2(M0824_1u(:,:,2),7,-0.03);
CC = bwconncomp(mask,4);
beads_M0824_1 = beadDataSet('oldimage', M0824_1u, CC, 2);
beads_M0824_1.CodingChannels = [lanthanideChannels.Dy lanthanideChannels.Sm];
beads_M0824_1.Transform = ICP(beads_M0824_1.getCodeRatio(:), target);
beads_M0130df_all = compositeBeadDataSet(beads_M0824_1);